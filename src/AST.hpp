...
public:
    ...
    public:
        ...
        void operator ++(int)
        {
            i++;    // int argument denotes postfix
        }
        void operator ++()
        {
            ++i;    // int argument denotes postfix
        }
        bool operator !=(const const_iterator &ii)
        {
            return i != ii.i;
        }
        Symbol *operator *()
    ...
    {
        return const_iterator(symbols.begin());
    }
    const_iterator end() const
    {
        return const_iterator(symbols.end());
    }
    size_t size() const
    {
        return symbols.size();
...
public:
    ...
    virtual Status visit(ModuleSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(VariableSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ConstantSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(BuiltinConstantSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(SignalSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(BuiltinSignalSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(TypeSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(BuiltinTypeSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(FunctionSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(BuiltinFunctionSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ProcedureSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(TaskSymbol& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(SymbolTable& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Literal& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(LoadVariableExpression& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(LoadSignalExpression& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(LoadSignalValueExpression& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(UnaryOp& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(BinaryOp& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(FunctionCall& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Delay& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(CheckCounter& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Module& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Exclusion& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Implication& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Counter& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Modules& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(PredicatedStatement& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(StatementList& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ParallelStatementList& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Nothing& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Pause& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Halt& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Emit& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Exit& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Sustain& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Assign& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ProcedureCall& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Present& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(If& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Loop& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Repeat& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Abort& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Await& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(LoopEach& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Every& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Suspend& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(DoWatching& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(DoUpto& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(TaskCall& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Exec& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Trap& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Signal& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Var& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(StartCounter& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(TypeRenaming& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ConstantRenaming& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(FunctionRenaming& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ProcedureRenaming& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(SignalRenaming& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Run& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(IfThenElse& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(EnterGRC& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(ExitGRC& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Nop& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(DefineSignal& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Switch& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Test& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(STSuspend& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Fork& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Sync& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Terminate& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Action& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(Enter& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(STexcl& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(STpar& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(STref& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(STleaf& n)
    {
        assert(0);
        return Status();
    }
    virtual Status visit(GRCgraph& n)
    {
        assert(0);
        return Status();
    }
