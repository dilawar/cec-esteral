...
ACLOCAL = ${SHELL} /Works/github/esterel-iitb/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Works/github/esterel-iitb/missing --run tar
ANTLR = 
AUTOCONF = ${SHELL} /Works/github/esterel-iitb/missing --run autoconf
AUTOHEADER = ${SHELL} /Works/github/esterel-iitb/missing --run autoheader
AUTOMAKE = ${SHELL} /Works/github/esterel-iitb/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LIBS = -lexpat 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Works/github/esterel-iitb/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /Works/github/esterel-iitb/install-sh
