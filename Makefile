...
ACLOCAL = ${SHELL} /Works/github/cec/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Works/github/cec/missing --run tar
ANTLR = 
AUTOCONF = ${SHELL} /Works/github/cec/missing --run autoconf
AUTOHEADER = ${SHELL} /Works/github/cec/missing --run autoheader
AUTOMAKE = ${SHELL} /Works/github/cec/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LIBS = -lexpat 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Works/github/cec/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /Works/github/cec/install-sh
