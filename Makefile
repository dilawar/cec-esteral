...
ACLOCAL = ${SHELL} /Work/github/cec/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Work/github/cec/missing --run tar
ANTLR = 
AUTOCONF = ${SHELL} /Work/github/cec/missing --run autoconf
AUTOHEADER = ${SHELL} /Work/github/cec/missing --run autoheader
AUTOMAKE = ${SHELL} /Work/github/cec/missing --run automake-1.9
AWK = gawk
CC = clang
...
LIBS = -lexpat 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Work/github/cec/missing --run makeinfo
...
infodir = ${prefix}/info
install_sh = /Work/github/cec/install-sh
